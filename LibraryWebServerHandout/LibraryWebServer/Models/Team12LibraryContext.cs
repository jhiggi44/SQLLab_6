...
{
    public partial class Team12LibraryContext : DbContext
    {
        public Team12LibraryContext()
        {
        }

        public Team12LibraryContext(DbContextOptions<Team12LibraryContext> options)
            : base(options)
        {
        }
